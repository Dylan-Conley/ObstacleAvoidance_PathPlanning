void generateMap()
{
  int q;
  Node n2;
  //loops through the whole width of the map
  for ( int ix = 0; ix < width/16.0; ix+=1 ) 
  {
    //for each lopop in width it goes through all the possible 
    //heights
...
//finds distance between two given x and y values (from a node)
